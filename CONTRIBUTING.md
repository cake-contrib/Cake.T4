# Contributing to Cake.T4

First and foremost, thank you! We appreciate that you want to contribute to Cake.T4,
...
Don't have time to contribute? No worries, here are some other ways to show your support for Cake.T4:

- star the [project][]
- tweet your support for Cake.T4
...
- **version**: (required) please note the version of Cake.T4 you are using
...
- **addins, etc**: (if applicable) please list any other addins you're using that may affect the Cake.T4 addin

### Closing issues

The original poster or the maintainers of Cake.T4 may close an issue at any time.
Typically, but not exclusively, issues are closed when:

- The issue is resolved, and will be released in the next version of Cake.T4
...
[project]: https://github.com/cake-contrib/Cake.T4
